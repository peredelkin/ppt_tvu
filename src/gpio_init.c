...
GPIO_PIN_CFG(GPIOI, GPIO_PIN_9, GPIO_MODE_OUT, GPIO_OTYPE_PP, GPIO_OSPEED_VERY_HIGH, GPIO_PUPD_NONE, GPIO_AF_0, GPIO_STATE_OFF),	/*11, PI9,		GPIO_Output,	OFF,	Reset_DI_App*/
